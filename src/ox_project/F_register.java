...
public class F_register extends javax.swing.JFrame {
   ...
   // public static boolean booleancheckID = false;
    ...
    private void initComponents() {
        ...
        btn_summit.setText("Submit");
        btn_summit.setkBackGroundColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkEndColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkHoverEndColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        btn_summit.setkHoverStartColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkPressedColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkSelectedColor(new java.awt.Color(255, 255, 255));
        btn_summit.setkStartColor(new java.awt.Color(0, 0, 153));
